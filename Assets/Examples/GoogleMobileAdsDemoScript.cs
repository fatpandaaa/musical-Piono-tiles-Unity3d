...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
		...
		void OnGUI ()
		{
				...
				Rect destroyInterstitialRect = new Rect (0.1f * Screen.width, 0.8f * Screen.height,
                                                0.8f * Screen.width, 0.1f * Screen.height);
				if (GUI.Button (destroyInterstitialRect, "chartboost full")) {
		...
		private void RequestBanner ()
		{
				...
				#elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-7339211814856003/5068087775";
				#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-7339211814856003/9498287371";
				#else
		...
		private void RequestInterstitial ()
		{
				...
				string adUnitId = "unused";
				#elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-7339211814856003/6544820973";
				#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-7339211814856003/1975020578";
				#else
            string adUnitId = "unexpected_platform";
				#endif
